...
namespace nc {
	struct Matrix33 {
		...
		void Scale(float s) {
			...
			m[0][1] = 0; m[1][0] = s; m[2][0] = 0;
			m[0][2] = 0; m[1][0] = 0; m[2][0] = 1;
		}

		void Scale(float sx, float sy) {
			m[0][0] = sx; m[1][0] = 0; m[2][0] = 0;
			m[0][1] = 0; m[1][0] = sy; m[2][0] = 0;
			m[0][2] = 0; m[1][0] = 0; m[2][0] = 1;
		}

		void Rotate(float angle) {
			m[0][0] = std::cos(angle); m[1][0] = std::sin(angle); m[2][0] = 0;
			m[0][1] = -std::sin(angle); m[1][1] = std::cos(angle); m[2][0] = 0;
			m[0][2] = 0; m[1][0] = 0; m[2][0] = 1;
		}

		void Translate (const Vector2& v) {
			m[0][0] = 1; m[1][0] = 0; m[2][0] = 0;
			m[0][1] = 0; m[1][0] = 1; m[2][0] = 0;
			m[0][2] = v.x; m[1][0] = v.y; m[2][0] = 1;
		}
